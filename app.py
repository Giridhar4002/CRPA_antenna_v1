...
# ──────────────────────────────────────────────────────
st.markdown("""
<div style="background: linear-gradient(135deg, #1a1d2e 0%, #0f1117 100%);
            border: 1px solid #2e3150; border-radius: 12px;
            padding: 24px 28px; margin-bottom: 20px;">

<h3 style="color: #00d4ff; margin-top: 0;">📖 Project Overview</h3>
<p style="color: #ccc; font-size: 0.95rem; line-height: 1.7;">
This interactive dashboard simulates a <b style="color:#fff;">Controlled Reception Pattern Antenna (CRPA)</b> —
a class of adaptive antenna arrays widely used in <b style="color:#fff;">GPS / GNSS receivers</b> to maintain
satellite lock in the presence of intentional jamming or unintentional interference.
The array consists of <b style="color:#fff;">square microstrip patch elements</b> arranged in a
<b style="color:#fff;">circular configuration</b> with an additional centre element, forming an
<b style="color:#fff;">N + 1</b> element topology.
</p>
<p style="color: #ccc; font-size: 0.95rem; line-height: 1.7;">
The core algorithm employs <b style="color:#fff;">projection-matrix null steering</b>, where the weight
vector is computed as <code style="color:#00d4ff;">w = P · a_d</code> with
<code style="color:#00d4ff;">P = I − Aₙ(AₙᴴAₙ)⁻¹Aₙᴴ</code>.
This projects the desired-direction steering vector onto the subspace orthogonal to the interference
directions, placing deep radiation-pattern nulls toward each specified jammer while preserving gain
toward the desired signal.
</p>

<hr style="border-color: #2e3150; margin: 16px 0;">

<h3 style="color: #2ecc71; margin-top: 0;">🧭 How to Use</h3>
<table style="color: #ccc; font-size: 0.9rem; line-height: 1.6; border-collapse: collapse; width: 100%;">
  <tr><td style="padding: 4px 12px 4px 0; vertical-align: top; white-space: nowrap;"><b style="color:#00d4ff;">① Array Setup</b></td>
      <td style="padding: 4px 0;">Use the <b style="color:#fff;">sidebar</b> to set the operating frequency, number of ring elements, and element spacing (× λ). A centre element is always included.</td></tr>
  <tr><td style="padding: 4px 12px 4px 0; vertical-align: top; white-space: nowrap;"><b style="color:#00d4ff;">② Desired Signal</b></td>
      <td style="padding: 4px 0;">Adjust <b style="color:#fff;">Desired Azimuth</b> and <b style="color:#fff;">Desired Elevation</b> sliders to steer the main beam toward the signal of interest (e.g., a GNSS satellite).</td></tr>
  <tr><td style="padding: 4px 12px 4px 0; vertical-align: top; white-space: nowrap;"><b style="color:#00d4ff;">③ Add Nulls</b></td>
      <td style="padding: 4px 0;">Select up to <b style="color:#fff;">4 nulls</b> and specify each jammer's azimuth & elevation. The algorithm will steer pattern nulls toward those directions.</td></tr>
  <tr><td style="padding: 4px 12px 4px 0; vertical-align: top; white-space: nowrap;"><b style="color:#00d4ff;">④ Analyse</b></td>
      <td style="padding: 4px 0;">Inspect polar & Cartesian azimuth patterns, elevation cut, element layout with weight magnitudes/phases, phasor diagram, and the Null Summary table.</td></tr>
  <tr><td style="padding: 4px 12px 4px 0; vertical-align: top; white-space: nowrap;"><b style="color:#00d4ff;">⑤ 3D View</b></td>
      <td style="padding: 4px 0;">Enable <b style="color:#fff;">Show 3D Pattern</b> in the sidebar for a full upper-hemisphere radiation pattern (takes a moment to render).</td></tr>
</table>

<hr style="border-color: #2e3150; margin: 16px 0;">

<h3 style="color: #e67e22; margin-top: 0;">⚠️ Assumptions & Limitations</h3>
<p style="color: #aaa; font-size: 0.85rem; line-height: 1.65; margin-bottom: 0;">
<b style="color:#ccc;">•</b> Element pattern modelled as <b style="color:#fff;">cos¹·⁵(θ)</b>, typical of a square microstrip patch.&nbsp;&nbsp;
<b style="color:#ccc;">•</b> Mutual coupling is <b style="color:#fff;">not</b> included; most accurate for spacings ≥ 0.4 λ.&nbsp;&nbsp;
<b style="color:#ccc;">•</b> Requires <b style="color:#fff;">fewer nulls than total elements</b> (N_nulls &lt; N_total).&nbsp;&nbsp;
<b style="color:#ccc;">•</b> All patterns shown relative to array-factor peak; absolute gain uses a simplified directivity model.
</p>
